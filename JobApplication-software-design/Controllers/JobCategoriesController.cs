...
namespace JobApplication_software_design.Controllers
{
    public class JobCategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,JobPostingId")] JobCategory jobCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,JobPostingId")] JobCategory jobCategory)
        {
